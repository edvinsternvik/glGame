...
namespace glGame {
	...
	public:
		...
		void submit(Model* model, const glm::mat4& modelMatrix, Material* material, const int& gameObjectId = -1, const int& layer = 0);
		void submit(Model* model, const glm::mat4& modelMatrix, Material* material, const UniformArray& uniforms, const int& gameObjectId = -1, const int& layer = 0);
		void submit(VertexArray* vertexArray, const unsigned int& verticies, const glm::mat4& modelMatrix, Material* material, const int& gameObjectId = -1, const int& layer = 0);
		void submit(Model* model, const glm::mat4& modelMatrix, Shader* shader, const int& gameObjectId = -1, const int& layer = 0);
		void submit(Model* model, const glm::mat4& modelMatrix, Shader* shader, const UniformArray& uniforms, const int& gameObjectId = -1, const int& layer = 0);
		void submit(const ObjectRenderData& objRenderData, const int& layer = 0);
		void submit(VertexArray* vertexArray, const unsigned int& verticies, const glm::mat4& modelMatrix, Shader* shader, const int& gameObjectId = -1, const int& layer = 0);
